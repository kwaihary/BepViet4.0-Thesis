...
function Menu() {
    ...
    // --- ĐÃ XÓA PHẦN RETURN BỊ THỪA Ở ĐÂY ---
        ...
        <nav className="bg-white shadow-sm fixed w-full z-50 top-0 h-16 border-b border-gray-200">
            <div className="container mx-auto px-4 h-full flex justify-between items-center max-w-7xl">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* SỬA LỖI: Thay 'user' bằng 'GiaTri' vì biến user không tồn tại */}
                    {GiaTri ? (
                        <div className="relative">
                            ...
                            GiaTri.id ? (
                                ...
                                <Link  to="/DangNhap" className="bg-red-600 hover:bg-red-700 text-white text-sm font-bold px-5 py-2.5 rounded-full shadow-md shadow-red-200 transition-all flex items-center gap-2" >
